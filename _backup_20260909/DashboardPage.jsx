...
export default function DashboardPage() {
  ...
  // Recent screenings source: either live state or initial sample list
  const recentScreeningsList = true ? screenings.slice(0, 5) : [
    {
      ...
      findingsSummary: 'AMD / ARMD: Possible finding'
    },
    {
      ...
      findingsSummary: 'BRVO: Possible finding, Glaucoma: Possible finding'
    },
    {
      ...
      drStage: 'stage0',
      drStageLabel: 'Stage 0 — No DR',
      findingsSummary: 'No significant finding detected'
    },
    {
      ...
      drStage: 'stage1',
      drStageLabel: 'Stage 1 — Mild',
      findingsSummary: 'Myopia: Possible finding'
    },
    {
      ...
      drStage: 'stage4',
      drStageLabel: 'Stage 4 — Proliferative DR',
      findingsSummary: 'AMD / ARMD: Needs review, BRVO: Possible finding'
    }
  ];
